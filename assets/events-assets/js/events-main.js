jQuery(document).ready(function($) {
    ...
    //SMOOTH SCROLL EFFECT
    $('[data-toggle="elementspnscroll"]').on("click", function(e) {
    ...
    $('#countdown').countdown({ until: new Date(2021, 10 - 1, 29, 9, 30, 0) }); // enter event day
...
$(window).load(function() {
    ...
    //PRELOADER
    $('#preload').delay(450).fadeOut('slow'); // will fade out the white DIV that covers the website.
